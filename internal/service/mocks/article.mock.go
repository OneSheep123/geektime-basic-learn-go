...
func (mr *MockArticleServiceMockRecorder) GetByAuthor(ctx, uid, offset, limit interface{}) *gomock.Call {
...
func (mr *MockArticleServiceMockRecorder) GetPubById(ctx, id, uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
